...
5. For context switching we are going to use the interrupt stub we have created in the [Interrupt Handling](05_InterruptHandling.md) chapter, of course this is not the only method available, but we found it useful for learning purposes.
